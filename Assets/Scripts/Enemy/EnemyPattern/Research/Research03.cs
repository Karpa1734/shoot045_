...
public class Research03 : BossPatternBase
{
    ...
    IEnumerator BitAttackRoutine()
    {
        ...
        while (true)
        {
            ...
            CreateRoundShot(PURPLE[0], transform.position + new Vector3(Random.Range(-1.5f,1.5f), Random.Range(-1.5f, 1.5f),0), bulletCount, Random.Range(3.0f,5.0f), angle, 5);
